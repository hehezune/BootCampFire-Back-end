...
public class QReviewLike extends EntityPathBase<ReviewLike> {
    ...
    private static final long serialVersionUID = -134890742L;
    ...
    public final com.ssafy.campfire.review.domain.QReview review;
    ...
    public QReviewLike(Class<? extends ReviewLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new com.ssafy.campfire.review.domain.QReview(forProperty("review"), inits.get("review")) : null;
